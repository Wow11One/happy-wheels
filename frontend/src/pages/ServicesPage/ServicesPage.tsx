...
const ServiceProviders = () => {
    ...
    useEffect(() => {
        const filtered = providers.filter((provider) => {
            return (
                (filters.location === "" || provider.city.toLowerCase().includes(filters.location.toLowerCase())) &&
                (filters.service === "" ||
                    provider.services.some((service) => service.toLowerCase().includes(filters.service.toLowerCase()))) &&
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                        ...
                        <div className="bg-gray-900 rounded-lg p-6 sticky top-4">
                            ...
                            <div className="space-y-6">
                                <div>
                                    ...
                                    <p onClick={() => getUserLocation()} className='text-sm text-gray-200 underline underline-offset-2 transition-all hover:cursor-pointer hover:text-gray-300'>
                                        Fetch automatically
                                    </p>
                                </div>
                    ...
                    <div className="lg:col-span-3">
                        <div className="mb-6">
                            <h3 className="text-2xl font-semibold">Service Providers ({filteredProviders.length})</h3>
                        </div>

                        {filteredProviders.length === 0 ? (
                            <div className="bg-gray-900 rounded-lg p-12 text-center">
                                <p className="text-gray-300 text-lg mb-4">No service providers found matching your criteria.</p>
                                <button
                                    onClick={clearFilters}
